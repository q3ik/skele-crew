...
#   Parse ops/protected-sections.manifest, extract the files: list under each
#   protected_block, and fail if any of those files were modified in this PR.
#   This catches direct edits that bypass PROPOSED_CHANGES.md entirely.
#
...
#   section tag. Proposals must never embed protected content inline.
#
